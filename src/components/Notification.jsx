...
const Notification = ({ bgColor, color, borderRadius }) => {
    ...
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="text-xl rounded-full p-2 hover:bg-light-gray inline-block md:active:bg-light-gray dark:text-gray-200"
